...
void setup()
{
  ...
  */
  ...
  while (!client.connected())
  {
   ...
   pinMode(redLEDPin, OUTPUT); // Set the pin mode for the LED after reconnecting to MQTT
}
...
{ // The loop function likely does not require change in the majority of circumstances.
  ...
  client.loop(); // Check for incomng messages and keep the connection alive
}